...
# https://github.com/mahyarx/openvpn-install
...
function installQuestions() {
	...
	echo "The git repository is available at: https://github.com/mahyarx/openvpn-install"
	echo ""

	echo "Let's ask a few questions before starting the setup."
	echo "You can leave the default options and just press enter if you are okay with them."
	echo ""
	echo "We need to know the IPv4 address of the network interface you want OpenVPN listening to."
	...
	echo "See https://github.com/mahyarx/openvpn-install#security-and-encryption to learn more."
	echo ""
